...
print('THIS IS NOT THE HABITAT USED IN THE PAPER, IT IS AN EXAMPLE TO MODIFY FOR YOUR OWN USE')
...
def makeTranspose(inParam):
    ...
    if True:
        ...
        #what water depths are included in the habitat, in meters
        minHabDepth=0.0
        maxHabDepth=100.0
    ...
    rootFileName='trimByDepth_%s_depth%d_minPLD%d_maxPLD%d_months%d_to_%d.zarr'%(habitatName,
                                                                      depth,minPLD,maxPLD,amin(inMonths),
                                                                                 amax(inMonths))
